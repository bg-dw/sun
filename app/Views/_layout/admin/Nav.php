...
<ul class="navbar-nav navbar-right d-print-none">
    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
        ...
        <div class="dropdown-menu dropdown-menu-right pullDown">
            ...
            <a href="<?= base_url('/' . bin2hex('admin') . '/' . bin2hex('update-username')) ?>"
                class="dropdown-item has-icon"> <i class="far fa-user"></i> Ganti Username
            </a>
            <a href="<?= base_url('/' . bin2hex('admin') . '/' . bin2hex('update-password')) ?>"
                class="dropdown-item has-icon"> <i class="fas fa-lock"></i>
                Ganti Password
            </a>
            <div class="dropdown-divider"></div>
            <a href="<?= base_url('/' . bin2hex('logout')) ?>" class="dropdown-item has-icon text-danger"> <i
