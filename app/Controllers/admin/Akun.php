...
class Akun extends BaseController
{
    ...
    public function update_uname()
    {
        ...
        return view('v_admin/V_username', $data);
    }
    //update password
    public function update_pass()
    {
        ...
        return view('v_admin/V_password', $data);
    }
    ...
    public function ac_set_uname()
    {
        ...
        return redirect()->route('/' . bin2hex('admin') . '/' . bin2hex('update-username'));
    }
    ...
    public function ac_set_password()
    {
        ...
        return redirect()->route(bin2hex('admin') . '/' . bin2hex('update-password'));
    }
}